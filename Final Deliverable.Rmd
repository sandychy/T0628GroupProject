...
>>>>>>> 5dbc54e3c6759dc9438ece50daa22a4551a271f5
...
### Train Model
```{r}
lr_base_model <- glm(Churn ~ ., data = data_train, family = "binomial")
...
```{r}
library(caret)
confusionMatrix(as.factor(lr_binary_pred), as.factor(data_test$Churn), positive = "1")
```
